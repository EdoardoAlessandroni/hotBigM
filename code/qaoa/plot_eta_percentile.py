...
ax.set_title(r"ma-QAOA, PO / optimality, $E_f = P_{75}$ of the feasible spectrum")
...
fig.tight_layout()
fig.savefig("misc_plots/PO_optimality_percentile_eta.pdf")
fig.savefig("misc_plots/PO_optimality_percentile_eta.png", dpi=170)
print("saved misc_plots/PO_optimality_percentile_eta.{pdf,png}")
