"""AUTO-GENERATED by make_legacy_module.py from qaoa_sampling_oneshot.py -- DO NOT EDIT.

Identical to qaoa_sampling_oneshot.py except the ma-QAOA stopping rule, which is reverted to the
pre-fix adjacent-difference test so that runs predating 2026-09-18 can be reproduced
exactly. Use ONLY for reproducing historical results; all new work uses qaoa_sampling_oneshot.py.
"""
