import numpy as np
import random
from myalgo import M_method_feas, M_method_opt ### TODO: add E_f estimation for the optimality strategy too
import os
import json
...
print(f"For this NPP instance of size N={N}, P={P}, seed={vseed}, the selected M is {M_star}, that gives effective success probability of {eta_eff} vs the guaranteed {eta_guaranteed} and the required {min_pfeas}")
print("M_l1 = ", M_L1)